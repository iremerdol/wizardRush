...
/// this class basically gathers up all the events
...
/// creating the screen for player selection.
/// adding character visuals and player selection buttons
...
/// creating the screen for main menu.
/// adding start and quit button
...
/// making visible the player, spawning enemies, updating score and so on
void Game::startGame(){
...
/// quitting the game when pressed to quit button
void Game::quitGame(){
    QApplication::quit();  // This will gracefully close the application
}

/// creating the screen for the game over menu.
/// adding play again and quit button
void Game::gameOver(){
    if (player){
        disconnect(this, SIGNAL(playerKeyPressed(QKeyEvent*)), player, SLOT(keyPressEvent(QKeyEvent*)));
